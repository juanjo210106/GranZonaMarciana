...
public class SolicitudAdapter extends ArrayAdapter<Solicitud> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvMensaje = convertView.findViewById(R.id.tvDescripcionSolicitud); // Usamos el ID del XML anterior

        if (s != null) {
            tvEstado.setText("ESTADO: " + s.getEstado().toString());
            tvMensaje.setText(s.getMensaje()); // USA TU CAMPO 'mensaje'
        }
